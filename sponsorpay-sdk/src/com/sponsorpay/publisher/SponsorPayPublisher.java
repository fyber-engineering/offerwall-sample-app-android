...
public class SponsorPayPublisher {
	...
	public static boolean getIntentForMBEActivity(Activity activity, SPBrandEngageRequestListener listener) {
		...
		String credentialsToken = SponsorPay.getCurrentCredentials().getCredentialsToken();
		return getIntentForMBEActivity(credentialsToken, activity, listener, null, null);
	}
	...
	public static boolean getIntentForMBEActivity(Activity activity, 
			SPBrandEngageRequestListener listener, String currencyId, String placementId) {
			
		String credentialsToken = SponsorPay.getCurrentCredentials().getCredentialsToken();
		return getIntentForMBEActivity(credentialsToken, activity, listener, currencyId, placementId);
	}
	 ...
	 */
	public static boolean getIntentForMBEActivity(Activity activity, 
			SPBrandEngageRequestListener listener, SPCurrencyServerListener vcsListener, String currencyId, String placementId) {
		String credentialsToken = SponsorPay.getCurrentCredentials().getCredentialsToken();
		return getIntentForMBEActivity(credentialsToken, activity, listener, null, null, vcsListener, currencyId, placementId);
	}
	...
	public static boolean getIntentForMBEActivity(String credentialsToken,
			Activity activity, SPBrandEngageRequestListener listener, String currencyId, String placementId) {
		return getIntentForMBEActivity(credentialsToken, activity, listener, null, null, null, currencyId, placementId);
	}
	...
	public static boolean getIntentForMBEActivity(String credentialsToken, Activity activity,
		...
		return getIntentForMBEActivity(credentialsToken, activity, listener, currencyName, parameters, vcsListener, null, null);
	}
